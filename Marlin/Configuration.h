...
#define STRING_CONFIG_H_AUTHOR "(Ricardo Mendes, New Revision)" // Who made the changes.
 ...
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {162,162,813,193}
//#define DEFAULT_AXIS_STEPS_PER_UNIT {200,200,3200,195} // default steps per unit for DRV8825 
//#define DEFAULT_AXIS_STEPS_PER_UNIT {200,200,1600,195} // default steps per unit for DRV8825 v2
#define DEFAULT_AXIS_STEPS_PER_UNIT {200,200,800,195} // default steps per unit for DRV8825 v3
...
#define DEFAULT_MAX_FEEDRATE {300,300, 5, 100} // (mm/sec) v2
...
#define DEFAULT_MAX_ACCELERATION        {2000,2000,100,10000} // X, Y, Z, E maximum start speed for accelerated moves. 
...
#define DEFAULT_ACCELERATION          400 // X, Y, Z and E max acceleration in mm/s^2 for printing moves v2
